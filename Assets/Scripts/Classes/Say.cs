...
public class Say : MonoBehaviour
{
    ...
    private void author_Text(AuthorText aT)
    {
        ...
        tx.text = aT.text + "\n s";
        tx.GetComponent<RectTransform>().sizeDelta = new Vector2(900, tx.preferredHeight);
        author.GetComponent<RectTransform>().sizeDelta = new Vector2(900, tx.preferredHeight + 100);
        tx.text = "";
